    ...
    return (
      <section className='form-page'>
        <div className='form-page__container'>
          <h2 className='form-page__text'>User successfully registered</h2>
    ...
    <section className='form-page'>
      <div className='form-page__container'>
        ...
        <form className='form-submit' onSubmit={handleSubmit(onSubmit)}>
          <input
            className={`${errors?.name && 'error'} form-submit__input `}
            type='text'
          ...
          />
          <label className='input__text error__text'>
            {errors?.name && errors?.name?.message}
          </label>
          <input
            className={`${errors?.email && 'error'} form-submit__input `}
            type='email'
            placeholder='Email'
            {...register('email', {
              required: 'Required field',
          ...
          <input
            className={`${errors?.phone && 'error'} form-submit__input `}
            type='phone'
          ...
          <div className='form-submit__radio position-radio'>
            ...
            <div className='position__item'>
              <input
                ...
                value='1'
                name='position'
                className='position__item__input'
                id='input__security'
                {...register('position', { required: 'Required field' })}
              />
              <label htmlFor='input__security' className='form__label'>
                Security
              </label>
            </div>
            <div className='position__item'>
              <input
                ...
                {...register('position', { required: 'Required field' })}
              />
              <label htmlFor='input__designer' className='form__label'>
                Designer
              </label>
            </div>
            <div className='position__item'>
              <input
                ...
                name='position'
                className='position__item__input'
                id='input__content_manager'
                {...register('position', { required: 'Required field' })}
              />
              <label htmlFor='input__content_manager' className='form__label'>
                Content manager
              </label>
            </div>
            <div className='position__item'>
              <input
                ...
                {...register('position', { required: 'Required field' })}
              />
              <label htmlFor='input__lawyer' className='form__label'>
                Lawyer
              </label>
            </div>
          </div>
            ...
            <div className='file__item'>
              <input
                ...
                {...register('img', {
                  ...
                  validate: {
                    lessThan5MB: (files) =>
                      files[0]?.size < 40000000 || 'Max 5Mb',
                    acceptedFormats: (files) =>
                      /jpg|jpeg/.test(files[0]?.name) ||
              ...
              <input
                type='text'
                className={`file__label ${errors?.name ? 'error' : ''}`}
                placeholder={imageName ? imageName : 'Upload your photo'}
              />
              <label
                className={`input__text file__label__message ${
                  errors?.img ? 'error__text' : ''
                }`}
              >
          ...
          <div className='form-submit__button-submit'>
            {serverError && (
              <label className='input__server__error error__text'>
                Server Error
              </label>
            )}
            <input
